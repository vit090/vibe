...
void main() {
	...
	`}var ro=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
</div>`,kl=function(e,t){var n=e[t];return Z.isArray(arguments[2])||Z.isObject(arguments[2])?new ml(e,t,arguments[2]):Z.isNumber(n)?Z.isNumber(arguments[2])&&Z.isNumber(arguments[3])?Z.isNumber(arguments[4])?new xl(e,t,arguments[2],arguments[3],arguments[4]):new xl(e,t,arguments[2],arguments[3]):Z.isNumber(arguments[4])?new yl(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new yl(e,t,{min:arguments[2],max:arguments[3]}):Z.isString(n)?new hl(e,t):Z.isFunction(n)?new Sl(e,t,``):Z.isBoolean(n)?new pl(e,t):null};function Al(e){setTimeout(e,1e3/60)}var jl=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Al,Ml=function(){function e(){el(this,e),this.backgroundElement=document.createElement(`div`),Z.extend(this.backgroundElement.style,{backgroundColor:`rgba(0,0,0,0.8)`,top:0,left:0,display:`none`,zIndex:`1000`,opacity:0,WebkitTransition:`opacity 0.2s linear`,transition:`opacity 0.2s linear`}),Q.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position=`fixed`,this.domElement=document.createElement(`div`),Z.extend(this.domElement.style,{position:`fixed`,display:`none`,zIndex:`1001`,opacity:0,WebkitTransition:`-webkit-transform 0.2s ease-out, opacity 0.2s linear`,transition:`transform 0.2s ease-out, opacity 0.2s linear`}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var t=this;Q.bind(this.backgroundElement,`click`,function(){t.hide()})}return tl(e,[{key:`show`,value:function(){var e=this;this.backgroundElement.style.display=`block`,this.domElement.style.display=`block`,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`,this.layout(),Z.defer(function(){e.backgroundElement.style.opacity=1,e.domElement.style.opacity=1,e.domElement.style.webkitTransform=`scale(1)`})}},{key:`hide`,value:function(){var e=this,t=function t(){e.domElement.style.display=`none`,e.backgroundElement.style.display=`none`,Q.unbind(e.domElement,`webkitTransitionEnd`,t),Q.unbind(e.domElement,`transitionend`,t),Q.unbind(e.domElement,`oTransitionEnd`,t)};Q.bind(this.domElement,`webkitTransitionEnd`,t),Q.bind(this.domElement,`transitionend`,t),Q.bind(this.domElement,`oTransitionEnd`,t),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`}},{key:`layout`,value:function(){this.domElement.style.left=window.innerWidth/2-Q.getWidth(this.domElement)/2+`px`,this.domElement.style.top=window.innerHeight/2-Q.getHeight(this.domElement)/2+`px`}}]),e}(),Nl=Uc(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);Dl.inject(Nl);var Pl=`dg`,Fl=72,Il=20,Ll=`Default`,Rl=function(){try{return!!window.localStorage}catch{return!1}}(),zl=void 0,Bl=!0,Vl=void 0,Hl=!1,Ul=[],$=function e(t){var n=this,r=t||{};this.domElement=document.createElement(`div`),this.__ul=document.createElement(`ul`),this.domElement.appendChild(this.__ul),Q.addClass(this.domElement,Pl),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=Z.defaults(r,{closeOnTop:!1,autoPlace:!0,width:e.DEFAULT_WIDTH}),r=Z.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),Z.isUndefined(r.load)?r.load={preset:Ll}:r.preset&&(r.load.preset=r.preset),Z.isUndefined(r.parent)&&r.hideable&&Ul.push(this),r.resizable=Z.isUndefined(r.parent)&&r.resizable,r.autoPlace&&Z.isUndefined(r.scrollable)&&(r.scrollable=!0);var i=Rl&&localStorage.getItem(Xl(this,`isLocal`))===`true`,a=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(e){n.parent?n.getRoot().preset=e:r.load.preset=e,ru(this),n.revert()}},width:{get:function(){return r.width},set:function(e){r.width=e,tu(n,e)}},name:{get:function(){return r.name},set:function(e){r.name=e,o&&(o.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(t){r.closed=t,r.closed?Q.addClass(n.__ul,e.CLASS_CLOSED):Q.removeClass(n.__ul,e.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=t?e.TEXT_OPEN:e.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return i},set:function(e){Rl&&(i=e,e?Q.bind(window,`unload`,a):Q.unbind(window,`unload`,a),localStorage.setItem(Xl(n,`isLocal`),e))}}}),Z.isUndefined(r.parent)){if(this.closed=r.closed||!1,Q.addClass(this.domElement,e.CLASS_MAIN),Q.makeSelectable(this.domElement,!1),Rl&&i){n.useLocalStorage=!0;var s=localStorage.getItem(Xl(this,`gui`));s&&(r.load=JSON.parse(s))}this.__closeButton=document.createElement(`div`),this.__closeButton.innerHTML=e.TEXT_CLOSED,Q.addClass(this.__closeButton,e.CLASS_CLOSE_BUTTON),r.closeOnTop?(Q.addClass(this.__closeButton,e.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(Q.addClass(this.__closeButton,e.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),Q.bind(this.__closeButton,`click`,function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var c=document.createTextNode(r.name);Q.addClass(c,`controller-name`),o=Wl(n,c),Q.addClass(this.__ul,e.CLASS_CLOSED),Q.addClass(o,`title`),Q.bind(o,`click`,function(e){return e.preventDefault(),n.closed=!n.closed,!1}),r.closed||(this.closed=!1)}r.autoPlace&&(Z.isUndefined(r.parent)&&(Bl&&=(Vl=document.createElement(`div`),Q.addClass(Vl,Pl),Q.addClass(Vl,e.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(Vl),!1),Vl.appendChild(this.domElement),Q.addClass(this.domElement,e.CLASS_AUTO_PLACE)),this.parent||tu(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},Q.bind(window,`resize`,this.__resizeHandler),Q.bind(this.__ul,`webkitTransitionEnd`,this.__resizeHandler),Q.bind(this.__ul,`transitionend`,this.__resizeHandler),Q.bind(this.__ul,`oTransitionEnd`,this.__resizeHandler),this.onResize(),r.resizable&&eu(this),a=function(){Rl&&localStorage.getItem(Xl(n,`isLocal`))===`true`&&localStorage.setItem(Xl(n,`gui`),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=a;function l(){var e=n.getRoot();e.width+=1,Z.defer(function(){--e.width})}r.parent||l()};$.toggleHide=function(){Hl=!Hl,Z.each(Ul,function(e){e.domElement.style.display=Hl?`none`:``})},$.CLASS_AUTO_PLACE=`a`,$.CLASS_AUTO_PLACE_CONTAINER=`ac`,$.CLASS_MAIN=`main`,$.CLASS_CONTROLLER_ROW=`cr`,$.CLASS_TOO_TALL=`taller-than-window`,$.CLASS_CLOSED=`closed`,$.CLASS_CLOSE_BUTTON=`close-button`,$.CLASS_CLOSE_TOP=`close-top`,$.CLASS_CLOSE_BOTTOM=`close-bottom`,$.CLASS_DRAG=`drag`,$.DEFAULT_WIDTH=245,$.TEXT_CLOSED=`Close Controls`,$.TEXT_OPEN=`Open Controls`,$._keydownHandler=function(e){document.activeElement.type!==`text`&&(e.which===Fl||e.keyCode===Fl)&&$.toggleHide()},Q.bind(window,`keydown`,$._keydownHandler,!1),Z.extend($.prototype,{add:function(e,t){return Yl(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return Yl(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;Z.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw Error(`Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.`);this.autoPlace&&Vl.removeChild(this.domElement);var e=this;Z.each(this.__folders,function(t){e.removeFolder(t)}),Q.unbind(window,`keydown`,$._keydownHandler,!1),Gl(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw Error(`You already have a folder in this GUI by the name "`+e+`"`);var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new $(t);this.__folders[e]=n;var r=Wl(this,n.domElement);return Q.addClass(r,`folder`),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Gl(e);var t=this;Z.each(e.__folders,function(t){e.removeFolder(t)}),Z.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display=`none`},show:function(){this.domElement.style.display=``},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=Q.getOffset(e.__ul).top,n=0;Z.each(e.__ul.childNodes,function(t){e.autoPlace&&t===e.__save_row||(n+=Q.getHeight(t))}),window.innerHeight-t-Il<n?(Q.addClass(e.domElement,$.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-Il+`px`):(Q.removeClass(e.domElement,$.CLASS_TOO_TALL),e.__ul.style.height=`auto`)}e.__resize_handle&&Z.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+`px`}),e.__closeButton&&(e.__closeButton.style.width=e.width+`px`)},onResizeDebounced:Z.debounce(function(){this.onResize()},50),remember:function(){if(Z.isUndefined(zl)&&(zl=new Ml,zl.domElement.innerHTML=Ol),this.parent)throw Error(`You can only call remember on a top level GUI.`);var e=this;Z.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&$l(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&tu(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||={},e.remembered[this.preset]=nu(this)),e.folders={},Z.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=nu(this),Kl(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[Ll]=nu(this,!0)),this.load.remembered[e]=nu(this),this.preset=e,Zl(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){Z.each(this.__controllers,function(t){this.getRoot().load.remembered?Jl(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),Z.each(this.__folders,function(e){e.revert(e)}),e||Kl(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&iu(this.__listening)},updateDisplay:function(){Z.each(this.__controllers,function(e){e.updateDisplay()}),Z.each(this.__folders,function(e){e.updateDisplay()})}});function Wl(e,t,n){var r=document.createElement(`li`);return t&&r.appendChild(t),n?e.__ul.insertBefore(r,n):e.__ul.appendChild(r),e.onResize(),r}function Gl(e){Q.unbind(window,`resize`,e.__resizeHandler),e.saveToLocalStorageIfPossible&&Q.unbind(window,`unload`,e.saveToLocalStorageIfPossible)}function Kl(e,t){var n=e.__preset_select[e.__preset_select.selectedIndex];n.innerHTML=t?n.value+`*`:n.value}function ql(e,t,n){if(n.__li=t,n.__gui=e,Z.extend(n,{options:function(t){if(arguments.length>1){var r=n.__li.nextElementSibling;return n.remove(),Yl(e,n.object,n.property,{before:r,factoryArgs:[Z.toArray(arguments)]})}if(Z.isArray(t)||Z.isObject(t)){var i=n.__li.nextElementSibling;return n.remove(),Yl(e,n.object,n.property,{before:i,factoryArgs:[t]})}},name:function(e){return n.__li.firstElementChild.firstElementChild.innerHTML=e,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof xl){var r=new yl(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});Z.each([`updateDisplay`,`onChange`,`onFinishChange`,`step`,`min`,`max`],function(e){var t=n[e],i=r[e];n[e]=r[e]=function(){var e=Array.prototype.slice.call(arguments);return i.apply(r,e),t.apply(n,e)}}),Q.addClass(t,`has-slider`),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof yl){var i=function(t){if(Z.isNumber(n.__min)&&Z.isNumber(n.__max)){var r=n.__li.firstElementChild.firstElementChild.innerHTML,i=n.__gui.__listening.indexOf(n)>-1;n.remove();var a=Yl(e,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return a.name(r),i&&a.listen(),a}return t};n.min=Z.compose(i,n.min),n.max=Z.compose(i,n.max)}else n instanceof pl?(Q.bind(t,`click`,function(){Q.fakeEvent(n.__checkbox,`click`)}),Q.bind(n.__checkbox,`click`,function(e){e.stopPropagation()})):n instanceof Sl?(Q.bind(t,`click`,function(){Q.fakeEvent(n.__button,`click`)}),Q.bind(t,`mouseover`,function(){Q.addClass(n.__button,`hover`)}),Q.bind(t,`mouseout`,function(){Q.removeClass(n.__button,`hover`)})):n instanceof Cl&&(Q.addClass(t,`color`),n.updateDisplay=Z.compose(function(e){return t.style.borderLeftColor=n.__color.toString(),e},n.updateDisplay),n.updateDisplay());n.setValue=Z.compose(function(t){return e.getRoot().__preset_select&&n.isModified()&&Kl(e.getRoot(),!0),t},n.setValue)}function Jl(e,t){var n=e.getRoot(),r=n.__rememberedObjects.indexOf(t.object);if(r!==-1){var i=n.__rememberedObjectIndecesToControllers[r];if(i===void 0&&(i={},n.__rememberedObjectIndecesToControllers[r]=i),i[t.property]=t,n.load&&n.load.remembered){var a=n.load.remembered,o=void 0;if(a[e.preset])o=a[e.preset];else if(a[Ll])o=a[Ll];else return;if(o[r]&&o[r][t.property]!==void 0){var s=o[r][t.property];t.initialValue=s,t.setValue(s)}}}}function Yl(e,t,n,r){if(t[n]===void 0)throw Error(`Object "`+t+`" has no property "`+n+`"`);var i=void 0;if(r.color)i=new Cl(t,n);else{var a=[t,n].concat(r.factoryArgs);i=kl.apply(e,a)}r.before instanceof cl&&(r.before=r.before.__li),Jl(e,i),Q.addClass(i.domElement,`c`);var o=document.createElement(`span`);Q.addClass(o,`property-name`),o.innerHTML=i.property;var s=document.createElement(`div`);s.appendChild(o),s.appendChild(i.domElement);var c=Wl(e,s,r.before);return Q.addClass(c,$.CLASS_CONTROLLER_ROW),i instanceof Cl?Q.addClass(c,`color`):Q.addClass(c,$c(i.getValue())),ql(e,c,i),e.__controllers.push(i),i}function Xl(e,t){return document.location.href+`.`+t}function Zl(e,t,n){var r=document.createElement(`option`);r.innerHTML=t,r.value=t,e.__preset_select.appendChild(r),n&&(e.__preset_select.selectedIndex=e.__preset_select.length-1)}function Ql(e,t){t.style.display=e.useLocalStorage?`block`:`none`}function $l(e){var t=e.__save_row=document.createElement(`li`);Q.addClass(e.domElement,`has-save`),e.__ul.insertBefore(t,e.__ul.firstChild),Q.addClass(t,`save-row`);var n=document.createElement(`span`);n.innerHTML=`&nbsp;`,Q.addClass(n,`button gears`);var r=document.createElement(`span`);r.innerHTML=`Save`,Q.addClass(r,`button`),Q.addClass(r,`save`);var i=document.createElement(`span`);i.innerHTML=`New`,Q.addClass(i,`button`),Q.addClass(i,`save-as`);var a=document.createElement(`span`);a.innerHTML=`Revert`,Q.addClass(a,`button`),Q.addClass(a,`revert`);var o=e.__preset_select=document.createElement(`select`);if(e.load&&e.load.remembered?Z.each(e.load.remembered,function(t,n){Zl(e,n,n===e.preset)}):Zl(e,Ll,!1),Q.bind(o,`change`,function(){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].innerHTML=e.__preset_select[t].value;e.preset=this.value}),t.appendChild(o),t.appendChild(n),t.appendChild(r),t.appendChild(i),t.appendChild(a),Rl){var s=document.getElementById(`dg-local-explain`),c=document.getElementById(`dg-local-storage`),l=document.getElementById(`dg-save-locally`);l.style.display=`block`,localStorage.getItem(Xl(e,`isLocal`))===`true`&&c.setAttribute(`checked`,`checked`),Ql(e,s),Q.bind(c,`change`,function(){e.useLocalStorage=!e.useLocalStorage,Ql(e,s)})}var u=document.getElementById(`dg-new-constructor`);Q.bind(u,`keydown`,function(e){e.metaKey&&(e.which===67||e.keyCode===67)&&zl.hide()}),Q.bind(n,`click`,function(){u.innerHTML=JSON.stringify(e.getSaveObject(),void 0,2),zl.show(),u.focus(),u.select()}),Q.bind(r,`click`,function(){e.save()}),Q.bind(i,`click`,function(){var t=prompt(`Enter a new preset name.`);t&&e.saveAs(t)}),Q.bind(a,`click`,function(){e.revert()})}function eu(e){var t=void 0;e.__resize_handle=document.createElement(`div`),Z.extend(e.__resize_handle.style,{width:`6px`,marginLeft:`-3px`,height:`200px`,cursor:`ew-resize`,position:`absolute`});function n(n){return n.preventDefault(),e.width+=t-n.clientX,e.onResize(),t=n.clientX,!1}function r(){Q.removeClass(e.__closeButton,$.CLASS_DRAG),Q.unbind(window,`mousemove`,n),Q.unbind(window,`mouseup`,r)}function i(i){return i.preventDefault(),t=i.clientX,Q.addClass(e.__closeButton,$.CLASS_DRAG),Q.bind(window,`mousemove`,n),Q.bind(window,`mouseup`,r),!1}Q.bind(e.__resize_handle,`mousedown`,i),Q.bind(e.__closeButton,`mousedown`,i),e.domElement.insertBefore(e.__resize_handle,e.domElement.firstElementChild)}function tu(e,t){e.domElement.style.width=t+`px`,e.__save_row&&e.autoPlace&&(e.__save_row.style.width=t+`px`),e.__closeButton&&(e.__closeButton.style.width=t+`px`)}function nu(e,t){var n={};return Z.each(e.__rememberedObjects,function(r,i){var a={},o=e.__rememberedObjectIndecesToControllers[i];Z.each(o,function(e,n){a[n]=t?e.initialValue:e.getValue()}),n[i]=a}),n}function ru(e){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].value===e.preset&&(e.__preset_select.selectedIndex=t)}function iu(e){e.length!==0&&jl.call(window,function(){iu(e)}),Z.each(e,function(e){e.updateDisplay()})}var au=$,ou={distance:27,yaw:35,pitch:45,followSpeed:8},su={size:200,divisions:50,textureTileSize:4},cu={color:8900331,fogNear:40,fogFar:140},lu={moveSpeed:3.5,radius:1.5,hurtboxRadius:.5,maxHp:20,attackDamage:5,attackRange:3,attackCooldown:.6,attackKnockback:6},uu={wanderRadius:6,wanderIntervalMin:2,wanderIntervalMax:5,aggroLeashMultiplier:1.6},du={clusterCount:5,enemiesPerCluster:4,clusterRadius:5,minSpawnDistance:25,maxSpawnDistance:65,respawnDelay:8},fu={hitFlashDuration:.15,deathFlipDuration:.6,damagePopupDuration:.8,damagePopupRise:40,knockbackDamping:8},pu={duration:.6},mu={radius:8,cost:20,depositInterval:.15,attackDamageIncrease:3,maxHpIncrease:5,attackRangeIncrease:.3,moveSpeedIncrease:.4,cooldownSeconds:60},hu={strength:8e-4},gu={hitboxColor:16711680,hitboxOpacity:.6},_u={maxRadius:50},vu={breatheFrequency:.85,breatheAmount:.08,jogBaseFrequency:1.5,jogSpeedFrequency:.8,jogBounceHeight:.15,jogStretchAmount:.12,blendSpeed:6};function yu(e,t,n,r,i,a){let o=e-r,s=t-i,c=n+a;return o*o+s*s<=c*c}function bu(e){for(let t of e)if(t.alive)for(let n of e)n!==t&&n.alive&&yu(t.object.position.x,t.object.position.z,t.hitboxRadius,n.object.position.x,n.object.position.z,n.hurtboxRadius)&&n.onHit(t)}var xu=class e{static FIXED_TIMESTEP=1/30;onEntityRemoved=null;entities=[];accumulator=0;add(e){this.entities.push(e)}remove(e){let t=this.entities.indexOf(e);t!==-1&&this.entities.splice(t,1)}update(t){for(this.accumulator+=t;this.accumulator>=e.FIXED_TIMESTEP;){for(let t of this.entities)t.fixedUpdate(e.FIXED_TIMESTEP);bu(this.entities),this.removeDead(),this.accumulator-=e.FIXED_TIMESTEP}for(let e of this.entities)e.update(t)}removeDead(){for(let e=this.entities.length-1;e>=0;e--){let t=this.entities[e];t.alive||(this.entities.splice(e,1),this.onEntityRemoved?.(t))}}},Su=class{direction={x:0,y:0};active=!1;pointerId=null;baseX=0;baseY=0;target;baseEl;stickEl;constructor(e){this.target=e,this.baseEl=document.createElement(`div`),this.baseEl.className=`joystick-base`,this.stickEl=document.createElement(`div`),this.stickEl.className=`joystick-stick`,this.baseEl.appendChild(this.stickEl),this.baseEl.style.display=`none`,document.body.appendChild(this.baseEl),e.addEventListener(`pointerdown`,this.onPointerDown),window.addEventListener(`pointermove`,this.onPointerMove),window.addEventListener(`pointerup`,this.onPointerUp),window.addEventListener(`pointercancel`,this.onPointerUp)}dispose(){this.target.removeEventListener(`pointerdown`,this.onPointerDown),window.removeEventListener(`pointermove`,this.onPointerMove),window.removeEventListener(`pointerup`,this.onPointerUp),window.removeEventListener(`pointercancel`,this.onPointerUp),this.baseEl.remove()}onPointerDown=e=>{this.active||(this.active=!0,this.pointerId=e.pointerId,this.baseX=e.clientX,this.baseY=e.clientY,this.baseEl.style.left=`${this.baseX}px`,this.baseEl.style.top=`${this.baseY}px`,this.baseEl.style.display=`block`,this.stickEl.style.transform=`translate(0px, 0px)`)};onPointerMove=e=>{if(!this.active||e.pointerId!==this.pointerId)return;let t=e.clientX-this.baseX,n=e.clientY-this.baseY,r=Math.min(Math.hypot(t,n),_u.maxRadius),i=Math.atan2(n,t),a=Math.cos(i)*r,o=Math.sin(i)*r;this.stickEl.style.transform=`translate(${a}px, ${o}px)`,this.direction.x=a/_u.maxRadius,this.direction.y=-o/_u.maxRadius};onPointerUp=e=>{e.pointerId===this.pointerId&&(this.active=!1,this.pointerId=null,this.direction.x=0,this.direction.y=0,this.baseEl.style.display=`none`)}},Cu={value:new G},wu={value:hu.strength};function Tu(e){return e.onBeforeCompile=e=>{e.uniforms.uBendCameraPosition=Cu,e.uniforms.uBendStrength=wu,e.vertexShader=e.vertexShader.replace(`#include <common>`,`
        ...
        gl_Position = projectionMatrix * mvPosition;
        `)},e.needsUpdate=!0,e}function Eu(e){Cu.value.copy(e.position),wu.value=hu.strength}function Du(e){let t=new Jr(new hi(e*.9,e,32),Tu(new Ir({color:gu.hitboxColor,transparent:!0,opacity:gu.hitboxOpacity,side:2,depthWrite:!1})));return t.rotation.x=-Math.PI/2,t.position.y=.02,t}var Ou=class{object;radius;hitboxRadius;hurtboxRadius;maxHp;hp;team;attackDamage;attackKnockback;attackCooldownDuration;attackCooldownRemaining=0;knockbackVelocity=new G;alive=!0;hitboxMarker;dying=!1;deathElapsed=0;constructor(e=new xn,t={},n={}){this.object=e,this.radius=t.radius??.5,this.hitboxRadius=t.hitboxRadius??this.radius,this.hurtboxRadius=t.hurtboxRadius??this.radius,this.maxHp=n.maxHp??1,this.hp=this.maxHp,this.team=n.team??`neutral`,this.attackDamage=n.attackDamage??0,this.attackKnockback=n.attackKnockback??0,this.attackCooldownDuration=n.attackCooldown??1,this.hitboxMarker=Du(this.hitboxRadius),this.object.add(this.hitboxMarker)}get isDying(){return this.dying}setHitboxRadius(e){this.hitboxRadius=e,this.hitboxMarker.geometry.dispose(),this.hitboxMarker.geometry=new hi(e*.9,e,32)}increaseMaxHp(e){e<=0||(this.maxHp+=e,this.hp+=e)}tryConsumeAttack(){return this.attackCooldownRemaining>0?!1:(this.attackCooldownRemaining=this.attackCooldownDuration,!0)}takeDamage(e){this.dying||!this.alive||e<=0||(this.hp=Math.max(0,this.hp-e),this.onDamaged(e),this.hp<=0&&(this.dying=!0,this.deathElapsed=0,this.hitboxMarker.visible=!1,this.onDeath()))}onDamaged(e){}onDeath(){}onHitTaken(e){if(e.attackKnockback<=0)return;let t=this.object.position.clone().sub(e.object.position);t.y=0,t.lengthSq()<1e-6&&t.set(Math.random()-.5,0,Math.random()-.5),t.normalize(),this.knockbackVelocity.copy(t).multiplyScalar(e.attackKnockback)}update(e){if(this.attackCooldownRemaining>0&&(this.attackCooldownRemaining=Math.max(0,this.attackCooldownRemaining-e)),this.dying){this.deathElapsed+=e;let t=wt.smoothstep(this.deathElapsed,0,fu.deathFlipDuration);this.object.rotation.x=wt.lerp(0,Math.PI/2,t),this.deathElapsed>=fu.deathFlipDuration&&(this.alive=!1);return}this.knockbackVelocity.lengthSq()>1e-4?(this.object.position.addScaledVector(this.knockbackVelocity,e),this.knockbackVelocity.multiplyScalar(Math.exp(-fu.knockbackDamping*e))):this.knockbackVelocity.set(0,0,0)}fixedUpdate(e){}onHit(e){this.isDying||e.team===this.team||e.tryConsumeAttack()&&(this.takeDamage(e.attackDamage),this.onHitTaken(e))}},ku=Math.PI*2;function Au(e,t,n){let r=(t-e+Math.PI)%ku;return r<0&&(r+=ku),r-=Math.PI,e+r*n}var ju=class{root;marker;jogPhase;breathePhase;moveBlend=0;constructor(e,t,n={}){this.root=e,this.marker=t,this.jogPhase=n.phaseOffset??0,this.breathePhase=n.phaseOffset??0}update(e,t,n){let r=n>0?wt.clamp(t.length()/n,0,1):0,i=Math.min(1,vu.blendSpeed*e);if(this.moveBlend+=(+(r>.05)-this.moveBlend)*i,r>.05){let e=Math.atan2(t.x,t.z);this.root.rotation.y=Au(this.root.rotation.y,e,i)}let a=vu.jogBaseFrequency+r*vu.jogSpeedFrequency;this.jogPhase=(this.jogPhase+a*ku*e)%ku;let o=Math.abs(Math.sin(this.jogPhase))*vu.jogBounceHeight,s=Math.sin(this.jogPhase*2)*vu.jogStretchAmount;this.breathePhase=(this.breathePhase+vu.breatheFrequency*ku*e)%ku;let c=Math.sin(this.breathePhase)*vu.breatheAmount,l=wt.lerp(c,s,this.moveBlend);this.marker.scale.set(1-l*.5,1+l,1-l*.5),this.marker.position.y=o*this.moveBlend}},Mu=null,Nu=null;function Pu(e,t){Mu=e,Nu=t}function Fu(e,t){if(!Mu||!Nu)return;let n=e.clone().project(Mu),r=Nu.domElement.getBoundingClientRect(),i=r.left+(n.x+1)/2*r.width,a=r.top+(1-n.y)/2*r.height,o=document.createElement(`div`);o.className=`damage-popup`,o.textContent=`-${Math.round(t)}`,o.style.left=`${i}px`,o.style.top=`${a}px`,o.style.transition=`transform ${fu.damagePopupDuration}s ease-out, opacity ${fu.damagePopupDuration}s ease-out`,document.body.appendChild(o),requestAnimationFrame(()=>{o.style.transform=`translate(-50%, -${fu.damagePopupRise}px)`,o.style.opacity=`0`}),setTimeout(()=>o.remove(),fu.damagePopupDuration*1e3)}function Iu(){let e=document.createElement(`div`);e.className=`game-over`,e.textContent=`You Died`,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add(`game-over--visible`)),setTimeout(()=>window.location.reload(),fu.deathFlipDuration*1e3+500)}function Lu(e){return Math.hypot(e.x,e.z)<mu.radius}var Ru=class extends Ou{velocity=new G;level=1;moveSpeed;input;marker;material;animator;flashTimer=0;constructor(e){super(new xn,{radius:lu.radius,hitboxRadius:lu.attackRange,hurtboxRadius:lu.hurtboxRadius},{maxHp:lu.maxHp,team:`player`,attackDamage:lu.attackDamage,attackCooldown:lu.attackCooldown,attackKnockback:lu.attackKnockback}),this.input=e,this.moveSpeed=lu.moveSpeed;let t=new di(1,1,1);t.translate(0,.5,0),this.material=Tu(new Ei({color:43775})),this.marker=new Jr(t,this.material),this.object.add(this.marker),this.animator=new ju(this.object,this.marker)}applyUpgrade(){this.level+=1,this.attackDamage+=mu.attackDamageIncrease,this.increaseMaxHp(mu.maxHpIncrease),this.setHitboxRadius(this.hitboxRadius+mu.attackRangeIncrease),this.moveSpeed+=mu.moveSpeedIncrease}onDamaged(e){this.flashTimer=fu.hitFlashDuration;let t=this.object.position.clone();t.y+=1.8,Fu(t,e)}onDeath(){Iu()}onHit(e){Lu(this.object.position)||super.onHit(e)}update(e){if(super.update(e),this.isDying)return;let{x:t,y:n}=this.input.direction;this.velocity.set(t*this.moveSpeed,0,-n*this.moveSpeed),this.object.position.addScaledVector(this.velocity,e),this.animator.update(e,this.velocity,this.moveSpeed),this.flashTimer>0&&(this.flashTimer=Math.max(0,this.flashTimer-e),this.material.emissive.setScalar(this.flashTimer/fu.hitFlashDuration))}},zu=0,Bu=new Set;function Vu(){return zu}function Hu(e){if(e!==0){zu+=e;for(let t of Bu)t(zu,e)}}function Uu(e){return Bu.add(e),()=>Bu.delete(e)}var Wu=`
...
`,Gu=null,Ku=null,qu=null;function Ju(e,t,n){Gu=e,Ku=t,qu=n}function Yu(e,t){if(!Gu||!Ku||!qu)return;let n=e.clone().project(Gu),r=Ku.domElement.getBoundingClientRect(),i=r.left+(n.x+1)/2*r.width,a=r.top+(1-n.y)/2*r.height,o=qu.getBoundingClientRect(),s=o.left+o.width/2,c=o.top+o.height/2,l=document.createElement(`div`);l.className=`coin-fly`,l.innerHTML=Wu,l.style.left=`${i}px`,l.style.top=`${a}px`,l.style.transition=`transform ${pu.duration}s ease-in, opacity ${pu.duration}s ease-in`,document.body.appendChild(l),requestAnimationFrame(()=>{l.style.transform=`translate(calc(-50% + ${s-i}px), calc(-50% + ${c-a}px)) scale(0.4)`,l.style.opacity=`0.5`}),setTimeout(()=>{l.remove(),Hu(t)},pu.duration*1e3)}function Xu(e){if(!Gu||!Ku||!qu)return;let t=qu.getBoundingClientRect(),n=t.left+t.width/2+(Math.random()*2-1)*6,r=t.top+t.height/2+(Math.random()*2-1)*6,i=e.clone().add(new G((Math.random()*2-1)*.6,Math.random()*.6,(Math.random()*2-1)*.6)).project(Gu),a=Ku.domElement.getBoundingClientRect(),o=a.left+(i.x+1)/2*a.width,s=a.top+(1-i.y)/2*a.height,c=document.createElement(`div`);c.className=`coin-fly`,c.innerHTML=Wu,c.style.left=`${n}px`,c.style.top=`${r}px`,c.style.transition=`transform ${pu.duration}s ease-in, opacity ${pu.duration}s ease-in`,document.body.appendChild(c),requestAnimationFrame(()=>{c.style.transform=`translate(calc(-50% + ${o-n}px), calc(-50% + ${s-r}px)) scale(1.2)`,c.style.opacity=`0.7`}),setTimeout(()=>c.remove(),pu.duration*1e3)}var Zu=class extends Ou{clusterId;velocity=new G;type;material;animator;flashTimer=0;chaseTarget;isChasing=!1;home;wanderTarget;wanderTimer=0;constructor(e,t,n,r){super(new xn,{radius:n.radius,hitboxRadius:n.attackRange},{maxHp:n.maxHp,team:`enemy`,attackDamage:n.attackDamage,attackCooldown:n.attackCooldown,attackKnockback:n.attackKnockback}),this.type=n,this.clusterId=r,this.object.position.copy(e),this.home=e.clone(),this.wanderTarget=e.clone(),this.chaseTarget=t;let i=new pi(n.radius,1,12);i.translate(0,.5,0),this.material=Tu(new Ei({color:n.color}));let a=new Jr(i,this.material);this.object.add(a),this.animator=new ju(this.object,a,{phaseOffset:Math.random()*Math.PI*2}),this.pickNewWanderTarget()}pickNewWanderTarget(){let e=Math.random()*Math.PI*2,t=Math.random()*uu.wanderRadius;this.wanderTarget=this.home.clone().add(new G(Math.cos(e)*t,0,Math.sin(e)*t)),this.wanderTimer=wt.lerp(uu.wanderIntervalMin,uu.wanderIntervalMax,Math.random())}onDamaged(e){this.flashTimer=fu.hitFlashDuration;let t=this.object.position.clone();t.y+=this.type.radius+.6,Fu(t,e)}onDeath(){let e=this.object.position.clone();e.y+=1,Yu(e,this.type.coinReward)}update(e){if(super.update(e),this.isDying)return;let t=this.chaseTarget.object.position.clone().sub(this.object.position);t.y=0;let n=t.length(),r=this.chaseTarget.alive&&!this.chaseTarget.isDying&&!Lu(this.chaseTarget.object.position);r&&n<=this.type.aggroRange?this.isChasing=!0:(!r||n>this.type.aggroRange*uu.aggroLeashMultiplier)&&(this.isChasing=!1);let i,a;this.isChasing?(i=this.chaseTarget.object.position,a=this.type.chaseSpeed):(this.wanderTimer-=e,this.wanderTimer<=0&&this.pickNewWanderTarget(),i=this.wanderTarget,a=this.type.wanderSpeed);let o=i.clone().sub(this.object.position);o.y=0,o.length()>.1?(o.normalize(),this.velocity.copy(o).multiplyScalar(a),this.object.position.addScaledVector(this.velocity,e)):this.velocity.set(0,0,0),this.animator.update(e,this.velocity,a),this.flashTimer>0&&(this.flashTimer=Math.max(0,this.flashTimer-e),this.material.emissive.setScalar(this.flashTimer/fu.hitFlashDuration))}},Qu={grunt:{id:`grunt`,label:`Grunt`,color:16729156,radius:.6,maxHp:10,attackDamage:4,attackKnockback:5,attackRange:1.2,attackCooldown:1,wanderSpeed:2,chaseSpeed:3,aggroRange:9,coinReward:5},runner:{id:`runner`,label:`Runner`,color:16772693,radius:.45,maxHp:6,attackDamage:2,attackKnockback:3,attackRange:1,attackCooldown:.7,wanderSpeed:3,chaseSpeed:4.2,aggroRange:11,coinReward:4},brute:{id:`brute`,label:`Brute`,color:9116186,radius:.9,maxHp:25,attackDamage:8,attackKnockback:10,attackRange:1.4,attackCooldown:1.4,wanderSpeed:1.2,chaseSpeed:1.8,aggroRange:7,coinReward:12},swarmer:{id:`swarmer`,label:`Swarmer`,color:14509823,radius:.35,maxHp:3,attackDamage:1,attackKnockback:2,attackRange:.8,attackCooldown:.5,wanderSpeed:3.5,chaseSpeed:3.8,aggroRange:8,coinReward:2},elite:{id:`elite`,label:`Elite`,color:16724940,radius:.85,maxHp:30,attackDamage:9,attackKnockback:9,attackRange:1.5,attackCooldown:.9,wanderSpeed:2.2,chaseSpeed:3.2,aggroRange:12,coinReward:20}},$u=[{type:Qu.grunt,weight:30},{type:Qu.runner,weight:25},{type:Qu.brute,weight:15},{type:Qu.swarmer,weight:20},{type:Qu.elite,weight:10}];function ed(){let e=$u.reduce((e,t)=>e+t.weight,0),t=Math.random()*e;for(let{type:e,weight:n}of $u){if(t<n)return e;t-=n}return $u[0].type}var td=class{clusters=[];chaseTarget;onSpawn;constructor(e,t){this.chaseTarget=e,this.onSpawn=t;for(let e=0;e<du.clusterCount;e++){let t=Math.random()*Math.PI*2,n=wt.lerp(du.minSpawnDistance,du.maxSpawnDistance,Math.random()),r=new G(Math.cos(t)*n,0,Math.sin(t)*n),i={id:e,center:r,type:ed(),aliveCount:0,pendingRespawns:[]};this.clusters.push(i);for(let e=0;e<du.enemiesPerCluster;e++)this.spawnEnemyInCluster(i)}}spawnEnemyInCluster(e){let t=new G((Math.random()*2-1)*du.clusterRadius,0,(Math.random()*2-1)*du.clusterRadius),n=new Zu(e.center.clone().add(t),this.chaseTarget,e.type,e.id);e.aliveCount+=1,this.onSpawn(n)}notifyEnemyRemoved(e){let t=this.clusters[e];t&&(t.aliveCount=Math.max(0,t.aliveCount-1),t.pendingRespawns.push(du.respawnDelay))}update(e){for(let t of this.clusters)for(let n=t.pendingRespawns.length-1;n>=0;n--)t.pendingRespawns[n]-=e,t.pendingRespawns[n]<=0&&(t.pendingRespawns.splice(n,1),this.spawnEnemyInCluster(t))}},nd=class{object;player;ringMaterial;priceLabel;camera;renderer;cooldownRemaining=0;progress=0;depositTimer=0;pulseTime=0;constructor(e,t,n){this.player=e,this.camera=t,this.renderer=n,this.object=new Sn;let r=new Jr(new fi(2.5,2.5,.3,32),Tu(new Ei({color:16766282,emissive:5586176})));r.position.y=.15,this.object.add(r);let i=new hi(mu.radius*.95,mu.radius,48);this.ringMaterial=Tu(new Ir({color:16766282,transparent:!0,opacity:.5,side:2,depthWrite:!1}));let a=new Jr(i,this.ringMaterial);a.rotation.x=-Math.PI/2,a.position.y=.03,this.object.add(a),this.priceLabel=document.createElement(`div`),this.priceLabel.className=`upgrade-price`,document.body.appendChild(this.priceLabel)}update(e){if(this.pulseTime+=e,this.cooldownRemaining>0?(this.cooldownRemaining=Math.max(0,this.cooldownRemaining-e),this.ringMaterial.opacity=.15):this.ringMaterial.opacity=.5+Math.sin(this.pulseTime*3)*.15,this.updatePriceLabel(),this.cooldownRemaining>0)return;let t=this.player.object.position.distanceTo(this.object.position)<=mu.radius,n=mu.cost-this.progress;if(!t||n<=0||Vu()<=0||(this.depositTimer-=e,this.depositTimer>0))return;this.depositTimer=mu.depositInterval,Hu(-1),this.progress+=1;let r=this.object.position.clone();r.y+=1.5,Xu(r),this.progress>=mu.cost&&(this.progress=0,this.cooldownRemaining=mu.cooldownSeconds,this.player.applyUpgrade(),this.showCompletionFlourish())}showCompletionFlourish(){if(!this.camera||!this.renderer)return;let e=this.object.position.clone();e.y+=2.5;let t=e.project(this.camera),n=this.renderer.domElement.getBoundingClientRect(),r=document.createElement(`div`);r.className=`coin-spend-popup`,r.textContent=`Upgraded!`,r.style.left=`${n.left+(t.x+1)/2*n.width}px`,r.style.top=`${n.top+(1-t.y)/2*n.height}px`,r.style.transition=`transform 1s ease-out, opacity 1s ease-out`,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform=`translate(-50%, -60px)`,r.style.opacity=`0`}),setTimeout(()=>r.remove(),1e3)}updatePriceLabel(){let e=this.object.position.clone();e.y+=3;let t=e.project(this.camera);if(t.z>1){this.priceLabel.style.display=`none`;return}let n=this.renderer.domElement.getBoundingClientRect();this.priceLabel.style.left=`${n.left+(t.x+1)/2*n.width}px`,this.priceLabel.style.top=`${n.top+(1-t.y)/2*n.height}px`,this.priceLabel.style.display=`block`,this.cooldownRemaining>0?this.priceLabel.textContent=`Recharging: ${Math.ceil(this.cooldownRemaining)}s`:this.progress>0?this.priceLabel.textContent=`Upgrade: ${this.progress} / ${mu.cost} coins`:this.priceLabel.textContent=`Upgrade: ${mu.cost} coins`}};function rd(){let e=document.createElement(`div`);e.className=`coin-hud`;let t=document.createElement(`div`);t.className=`coin-hud__icon`,t.innerHTML=Wu;let n=document.createElement(`span`);return n.className=`coin-hud__count`,n.textContent=String(Vu()),e.appendChild(t),e.appendChild(n),document.body.appendChild(e),Uu(e=>{n.textContent=String(e),t.classList.remove(`coin-hud__icon--pop`),t.offsetWidth,t.classList.add(`coin-hud__icon--pop`)}),t}function id(){let e=document.createElement(`div`);e.className=`health-bar`;let t=document.createElement(`div`);t.className=`health-bar__fill`,e.appendChild(t);let n=document.createElement(`span`);return n.className=`health-bar__label`,e.appendChild(n),document.body.appendChild(e),(e,r)=>{let i=r>0?Math.max(0,Math.min(1,e/r)):0;t.style.width=`${i*100}%`,n.textContent=`${Math.ceil(Math.max(0,e))} / ${r}`}}function ad(){let e=document.createElement(`div`);e.className=`stats-hud`;let t=document.createElement(`div`);t.className=`stats-hud__chip`;let n=document.createElement(`div`);n.className=`stats-hud__chip`;let r=document.createElement(`div`);return r.className=`stats-hud__chip`,e.append(t,n,r),document.body.appendChild(e),(e,i,a)=>{t.textContent=`Lv. ${e}`,n.textContent=`ATK ${i}`,r.textContent=`SPD ${a.toFixed(1)}`}}function od(){let t=document.createElement(`canvas`);t.width=256,t.height=256;let n=t.getContext(`2d`);n.fillStyle=`#4a9c3f`,n.fillRect(0,0,256,256);for(let e=0;e<5e3;e++){let e=Math.random();n.fillStyle=`rgb(${Math.floor(45+e*35)}, ${Math.floor(110+e*90)}, ${Math.floor(35+e*25)})`;let t=Math.random()*256,r=Math.random()*256,i=1+Math.random()*1.5,a=3+Math.random()*5;n.save(),n.translate(t,r),n.rotate((Math.random()-.5)*.8),n.fillRect(-i/2,-a/2,i,a),n.restore()}let r=new si(t);return r.wrapS=e,r.wrapT=e,r.colorSpace=Ie,r}var sd=document.querySelector(`#app`);sd.innerHTML=``;var cd=new jn;cd.background=new J(cu.color),cd.fog=new An(cu.color,cu.fogNear,cu.fogFar);var ld=new ta(75,window.innerWidth/window.innerHeight,.1,500),ud=new Hc({antialias:!0});ud.setSize(window.innerWidth,window.innerHeight),ud.setPixelRatio(window.devicePixelRatio),sd.appendChild(ud.domElement),Pu(ld,ud),Ju(ld,ud,rd());var dd=id(),fd=ad(),pd=new mi(su.size,su.size,su.divisions,su.divisions),md=od(),hd=su.size/su.textureTileSize;md.repeat.set(hd,hd);var gd=new Jr(pd,Tu(new Ei({map:md})));gd.rotation.x=-Math.PI/2,cd.add(gd);var _d=new ia(16777215,2);_d.position.set(2,2,2),cd.add(_d),cd.add(new aa(16777215,.3));var vd=new Su(ud.domElement),yd=new xu,bd=new Ru(vd);yd.add(bd),cd.add(bd.object);var xd=new td(bd,e=>{yd.add(e),cd.add(e.object)});yd.onEntityRemoved=e=>{cd.remove(e.object),e instanceof Zu&&xd.notifyEnemyRemoved(e.clusterId)};var Sd=new nd(bd,ld,ud);if(cd.add(Sd.object),new URLSearchParams(window.location.search).get(`dev`)===`1`){let e=new au,t=e.addFolder(`Camera`);t.add(ou,`distance`,1,50,.1),t.add(ou,`yaw`,-180,180,1),t.add(ou,`pitch`,-89,89,1),t.add(ou,`followSpeed`,.5,20,.5),t.open();let n=e.addFolder(`Player`);n.add(lu,`moveSpeed`,.5,20,.5),n.add(lu,`attackDamage`,1,20,1),n.add(lu,`attackCooldown`,.1,3,.1),n.open();let r=e.addFolder(`Enemy AI`);r.add(uu,`wanderRadius`,1,20,.5),r.add(uu,`wanderIntervalMin`,.5,10,.5),r.add(uu,`wanderIntervalMax`,.5,15,.5),r.add(uu,`aggroLeashMultiplier`,1,3,.1),r.open();let i=e.addFolder(`Cluster`);i.add(du,`enemiesPerCluster`,1,12,1),i.add(du,`clusterRadius`,1,20,.5),i.add(du,`respawnDelay`,1,30,1),i.open();let a=e.addFolder(`Animation`);a.add(vu,`breatheFrequency`,.1,3,.1),a.add(vu,`breatheAmount`,0,.2,.01),a.add(vu,`jogBaseFrequency`,0,5,.1),a.add(vu,`jogSpeedFrequency`,0,10,.1),a.add(vu,`jogBounceHeight`,0,.5,.01),a.add(vu,`jogStretchAmount`,0,.5,.01),a.add(vu,`blendSpeed`,.5,20,.5);let o=e.addFolder(`World Bend`);o.add(hu,`strength`,0,.005,1e-4),o.open();let s=e.addFolder(`Upgrade Station`);s.add(mu,`cost`,1,200,1),s.add(mu,`depositInterval`,.02,1,.01),s.add(mu,`attackDamageIncrease`,1,20,1),s.add(mu,`maxHpIncrease`,1,30,1),s.add(mu,`attackRangeIncrease`,0,2,.1),s.add(mu,`moveSpeedIncrease`,0,2,.1),s.add(mu,`cooldownSeconds`,1,120,1),s.open()}function Cd(e){let t=wt.degToRad(ou.yaw),n=wt.degToRad(ou.pitch),r=new G(ou.distance*Math.cos(n)*Math.sin(t),ou.distance*Math.sin(n),ou.distance*Math.cos(n)*Math.cos(t)).add(bd.object.position),i=1-Math.exp(-ou.followSpeed*e);ld.position.lerp(r,i),ld.lookAt(bd.object.position)}window.addEventListener(`resize`,()=>{ld.aspect=window.innerWidth/window.innerHeight,ld.updateProjectionMatrix(),ud.setSize(window.innerWidth,window.innerHeight)});var wd=new ua;wd.connect(document);function Td(){requestAnimationFrame(Td),wd.update();let e=Math.min(wd.getDelta(),.25);yd.update(e),xd.update(e),Sd.update(e),Cd(e),Eu(ld),dd(bd.hp,bd.maxHp),fd(bd.level,bd.attackDamage,bd.moveSpeed),ud.render(cd,ld)}Td();